...
namespace
{
    FHttpRequestHandler MakeHttpRequestHandler(FHttpRequestHandler Handler)
    {
        return MoveTemp(Handler);
    }
}

void FABTLocalBridgeServer::Start()
{
    UE_LOG(LogTemp, Display, TEXT("FABTLocalBridgeServer::Start entered"));
